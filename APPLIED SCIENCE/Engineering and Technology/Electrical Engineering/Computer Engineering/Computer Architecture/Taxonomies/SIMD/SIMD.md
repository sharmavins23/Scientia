...
Note that SIMD is NOT equivalent to [[Vector Processing]], though they are similar. The key difference is that SIMD works only on fixed-length 'vector' registers.
